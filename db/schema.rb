...
ActiveRecord::Schema.define(version: 20170827204624) do
  ...
  create_table "domain_tags", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
    t.text "description"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "domain_tags_spam_domains", primary_key: ["domain_tag_id", "spam_domain_id"], force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "posts_spam_domains", primary_key: ["post_id", "spam_domain_id"], force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spam_domains", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "domain"
    t.text "whois"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
