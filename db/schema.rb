...
ActiveRecord::Schema.define(version: 2018_07_05_110740) do
  ...
  create_table "abuse_reports", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["reportable_type", "reportable_id"], name: "index_abuse_reports_on_reportable_type_and_reportable_id", length: { reportable_type: 191 }
  ...
  create_table "list_items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "list_type_id"
    t.bigint "user_id"
    t.text "data"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "smoke_detector_id"
    t.index ["list_type_id"], name: "index_list_items_on_list_type_id"
    t.index ["smoke_detector_id"], name: "index_list_items_on_smoke_detector_id"
    t.index ["user_id"], name: "index_list_items_on_user_id"
  end

  create_table "list_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "review_items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["reviewable_type", "reviewable_id"], name: "index_review_items_on_reviewable_type_and_reviewable_id", length: { reviewable_type: 191 }
  end
  ...
  create_table "smoke_detectors", id: :bigint, default: 0, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "spam_domains", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "domain", collation: "utf8mb4_bin"
    t.text "whois", collation: "utf8mb4_bin"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "list_items", "smoke_detectors"
